...
function loadCarrierNames() {
  ...
  return {
    //台湾运营商 Taiwan
    '466-11': 'China Telecom', '466-92': 'China Telecom',
    '466-01': 'Yuanchuan Telecom', '466-03': 'Yuanchuan Telecom',
    '466-97': '台灣大哥大', '466-89': '台灣之星', '466-05': 'GT',
    //大陆运营商 China
    '460-03': 'China Telecom', '460-05': '中国电信', '460-11': '中国电信',
    '460-01': 'China Unicom', '460-06': 'China Unicom', '460-09': '中国联通',
    '460-00': 'China Mobile', '460-02': '中国移动', '460-04': '中国移动', '460-07': '中国移动', '460-08': 'China Mobile',
    ...
    '454-01': 'CITIC International Telecom', '454-07': 'UNICOM HK', '454-08': 'Truphone', '454-11': 'CHKTL', '454-23': 'Lycamobile',
    //日本运营商 Japan
...
function getIP() {
  ...
  let info = [];
  if (!v4 && !v6) {
    info = ['The network may be disconnected.', 'Please refresh manually to retake IP'];
  } else {
  ...
  httpMethod.get('http://ip-api.com/json').then(response => {
    ...
    if (retryTimes > 0) {
      ...
      $done({
        ...
        content: 'Unable to obtain current network information\nPlease check the network status and try again.',
...
(() => {
  ...
  setTimeout(() => {
    ...
    $done({
      ...
      content: "Connection request timeout\nPlease check the network status and try again.",
      icon: 'wifi.exclamationmark',
      'icon-color': '#CB1B45',
    });
